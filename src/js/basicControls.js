...
function Controls(
  ...
  function computeGeometryValues() {
    ...
    var alpha, intersection_y, y_vec1_red, y_vec2_red;
    
    if (x_vec1 < 0) {
      alpha = Math.atan2(x, y);
      intersection_y = r / Math.cos(alpha);

      y_vec1_red = y_vec1 - intersection_y;
    ...
    if (x_vec2 < 0) {
      ...
      y_vec2_red = y_vec2 - intersection_y;
